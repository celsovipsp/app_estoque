        ...
        <table class='table table-striped table-hover'>
            ...
            <?php
                foreach ($produtos as $produto){
                    ...
                    echo "<td>".App\Helper\Moeda::get($produto->getValidade())."</td>";
                    echo "<td><a class='btn btn-danger' href='produto-excluir
.php?id={$produto->getId()}'>Excluir</a></td>";
                    echo "<td><a class='btn btn-warning' href='produto-alterar
.php?id={$produto->getId()}'> Alterar</a></td>";
                    echo "</tr>";
                }
            ?>
        </table>
